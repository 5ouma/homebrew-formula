class Ogpk < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      def install
        bin.install "ogpk-0.1.3-darwin-amd64" => name.to_s
      end
    end
    if Hardware::CPU.arm?
      ...
      def install
        bin.install "ogpk-0.1.3-darwin-arm64" => name.to_s
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      def install
        bin.install "ogpk-0.1.3-linux-amd64" => name.to_s
      end
    end
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "ogpk-0.1.3-linux-arm64" => name.to_s
      end
    end
  end
end
