class GhDash < Formula
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/dlvhdr/gh-dash/releases/download/v4.2.0/gh-dash_v4.2.0_linux-amd64"
      sha256 "3221aad2b9d0b853ee2f8a52d83ec9114c7e53d5f4e331d2deaf41106fdb7730"
      def install
