class GhDash < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/dlvhdr/gh-dash/releases/download/v#{version}/darwin-amd64"
    ...
    if Hardware::CPU.arm?
      url "https://github.com/dlvhdr/gh-dash/releases/download/v#{version}/darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/dlvhdr/gh-dash/releases/download/v#{version}/linux-amd64"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/dlvhdr/gh-dash/releases/download/v#{version}/linux-arm64"
